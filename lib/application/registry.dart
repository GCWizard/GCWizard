...
void initializeRegistry(BuildContext context) {
  ...
  registeredTools = [
    ...
    GCWTool(tool: const MajorSystem(), id: 'major_system', isBeta: true, categories: const [
      ToolCategory.CRYPTOGRAPHY
    ], searchKeys: const [
      'major_system',
    ]),
    ...
    GCWTool(tool: const SummerSimmerIndex(), id: 'summersimmerindex', searchKeys: const [
      ...
      ToolLicenseOnlineArticle(
        ...
        sourceUrl: 'https://web.archive.org/web/20240910160710/http://summersimmer.com/home.htm',
      ),
      ToolLicenseOnlineArticle(
        context: context,
        author: 'vCalc',
    ...
    //BaconSelection **************************************************************************************************
    GCWTool(tool: const Bacon(), id: 'bacon', categories: const [], searchKeys: const [
      'bacon',
      'binary',
    ]),
    GCWTool(tool: const BaconAnalyze(), id: 'bacon_analyze', categories: const [], searchKeys: const [
      'bacon',
      'binary',
    ]),
    ...
    GCWTool(
        tool: const PeriodicTable(), id: 'periodictable', searchKeys: const [], licenses: [stl._toolLicensePSEWiki]),
    GCWTool(
    ...
    GCWSymbolTableTool(symbolKey: 'arcadian', symbolSearchStrings: const [
      ...
      ToolLicenseFont(
        ...
        sourceUrl: 'https://web.archive.org/web/20230628184941/http://arcadia.island.free.fr/down/police.zip',
        licenseType: ToolLicenseType.FREE_TO_USE,
      ),
    ]),
    ...
    GCWSymbolTableTool(symbolKey: 'color_add', symbolSearchStrings: const [
      ...
      ToolLicenseImage(
          ...
          sourceUrl: 'https://web.archive.org/web/20240629170653/https://www.coloradd.net/en/coloradd-code/',
          licenseType: ToolLicenseType.NON_COMMERCIAL,
          licenseUseType: ToolLicenseUseType.COPY)
    ]),
    ...
    GCWSymbolTableTool(
        symbolKey: 'enn_agrammaton',
        symbolSearchStrings: const ['symbol_trithemius', 'symbol_enn_agrammaton'],
        licenses: [stl._toolLicenseOnlineBookPolygraphieTrithemius]),
    ...
    GCWSymbolTableTool(
        ...
        symbolSearchStrings: const ['symbol_trithemius', 'symbol_tetragrammatique_v1'],
        licenses: [stl._toolLicenseOnlineBookPolygraphieTrithemius]),
    GCWSymbolTableTool(
        symbolKey: 'tetragrammatique_v2',
        symbolSearchStrings: const ['symbol_trithemius', 'symbol_tetragrammatique_v2'],
        licenses: [stl._toolLicenseOnlineBookPolygraphieTrithemius]),
