...
class CryptogramSolver {
  ...
  // Funktion, um ein Wort (z.B. 'ELEVEN') in eine Zahl umzuwandeln
  int wordToNumber(String word, Map<String, int> variableValues) {
    int number = 0;
    for (int i = 0; i < word.length; i++) {
      var char = word[i];
      number = number * 10 + variableValues[char]!;
    }
    return number;
  }
}
