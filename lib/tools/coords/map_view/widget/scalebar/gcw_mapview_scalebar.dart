...
class GCWMapViewScalebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final offsetDistance1 = camera.latLngToScreenOffset(latLngOffset1);
    final offsetDistance2 = camera.latLngToScreenOffset(latLngOffset2);
    final offsetDistance3 = camera.latLngToScreenOffset(latLngOffset3);
