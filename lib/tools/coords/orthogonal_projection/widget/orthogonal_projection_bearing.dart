...
class OrthogonalProjectionBearing extends StatefulWidget {
  const OrthogonalProjectionBearing({super.key});

  @override
  _OrthogonalProjectionBearingState createState() => _OrthogonalProjectionBearingState();
}

class _OrthogonalProjectionBearingState extends State<OrthogonalProjectionBearing> {
  ...
  void _calculateOutput() {
    _currentValues = [orthogonalProjectionBearing(_currentCoord.toLatLng()!, _currentStart.toLatLng()!, _currentBearing.value, defaultEllipsoid)];
