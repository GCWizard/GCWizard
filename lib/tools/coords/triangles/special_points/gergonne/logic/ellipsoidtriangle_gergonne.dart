...
SpecialPointsOfEllipsoidTriangle calculateEllipsoidTriangleGergonnePoint(EllipsoidTriangle triangle, Ellipsoid ellipsoid){
  ...
  return SpecialPointsOfEllipsoidTriangle([intersectAB, intersectBC, intersectAC], [
    SpecialPointConstructionLine(projA, _triangle.a),
    SpecialPointConstructionLine(projB, _triangle.b),
    SpecialPointConstructionLine(projC, _triangle.c),
  ], ellipsoid);
}