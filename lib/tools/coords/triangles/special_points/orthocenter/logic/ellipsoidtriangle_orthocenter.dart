...
SpecialPointsOfEllipsoidTriangle calculateEllipsoidTriangleOrthocenter(EllipsoidTriangle triangle, Ellipsoid ellipsoid) {
  ...
  return SpecialPointsOfEllipsoidTriangle([intersectionAB, intersectionBC, intersectionCA], [
      SpecialPointConstructionLine(_triangle.a, projA),
      SpecialPointConstructionLine(_triangle.b, projB),
      SpecialPointConstructionLine(_triangle.c, projC)
    ], ellipsoid
  );
}