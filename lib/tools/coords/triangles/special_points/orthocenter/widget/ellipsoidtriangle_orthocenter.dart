...
class EllipsoidTriangleOrthocenter extends StatefulWidget {
  const EllipsoidTriangleOrthocenter({
    super.key,
  });

  @override
  _EllipsoidTriangleOrthocenterState createState() => _EllipsoidTriangleOrthocenterState();
}

class _EllipsoidTriangleOrthocenterState extends State<EllipsoidTriangleOrthocenter> {
