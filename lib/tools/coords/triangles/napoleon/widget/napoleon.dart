...
class _TriangleNapoleonPointsState extends State<TriangleNapoleonPoints> {
  ...
  void _calculateOutput() {
    var napoleonPoints = calculateEllipsoidTriangleNapoleonPoints(
        _currentCoords1.toLatLng()!,
        _currentCoords2.toLatLng()!,
        _currentCoords3.toLatLng()!, defaultEllipsoid);

    _currentOutput = [
      buildCoordinate(_currentOutputFormat, napoleonPoints[0]) as Object,
      buildCoordinate(_currentOutputFormat, napoleonPoints[1]) as Object
    ];
    ...
    var mapPointNapoleonI = GCWMapPoint(
      point: napoleonPoints[0],
      color: COLOR_MAP_CALCULATEDPOINT,
      markerText: i18n(context, 'triangle_output_napoleon_outer'),
      coordinateFormat: _currentOutputFormat,
      circleColorSameAsPointColor: false,
    );
    var mapPointNapoleonII = GCWMapPoint(
      point: napoleonPoints[1],
      color: COLOR_MAP_CALCULATEDPOINT,
      markerText: i18n(context, 'triangle_output_napoleon_inner'),
      coordinateFormat: _currentOutputFormat,
      circleColorSameAsPointColor: false,
    );
