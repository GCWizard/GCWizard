...
SpecialPointsOfEllipsoidTriangle _intersections(_NapoleonLine a, _NapoleonLine b, _NapoleonLine c, Ellipsoid ellipsoid) {
  var intersectAB1 = intersectFourPoints(a.start, a.end, b.start, b.end, ellipsoid);
  var intersectBC1 = intersectFourPoints(b.start, b.end, c.start, c.end, ellipsoid);
  var intersectCA1 = intersectFourPoints(c.start, c.end, a.start, a.end, ellipsoid);

  return SpecialPointsOfEllipsoidTriangle([intersectAB1, intersectBC1, intersectCA1], ellipsoid);
}
