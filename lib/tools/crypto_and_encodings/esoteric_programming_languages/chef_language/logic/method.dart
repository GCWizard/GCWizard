...
class _Method {
  ...
  void _getMatchesENG(String line){
    List<RegExp> matchers = _CHEF_matchersENG;
  ...
  void _getMatchesDEU(String line) {
    List<RegExp> matchers = _CHEF_matchersDEU;
    if (matchers[0].hasMatch(line)) {
      ...
      verb = matchers[18].firstMatch(line)!.group(1)!;
      ingredient = matchers[18].firstMatch(line)!.group(4)!;
    } else if (matchers[19].hasMatch(line)) {
      // die zutat yyy
      type = _CHEF_Method.Wiederholen;
      verb = matchers[19].firstMatch(line)!.group(3)!;
      ingredient = matchers[19].firstMatch(line)!.group(2)!;
    } else {
      // invalid method
