...
void main() {
  ...
  group("SymbolArithmetic.solve:", () {
    ...
    List<Map<String, dynamic>> _inputsToExpected = [
      // {'input' : null, 'expectedOutput' : {'state': 'error', 'output': [{'result': null, 'state': 'error'}]}},
      // {'input' : null, 'expectedOutput' : {'state': 'error', 'output': [{'result': null, 'state': 'error'}]}},
      // {'input' : null, 'expectedOutput' : {'state': 'error', 'output': [{'result': null, 'state': 'error'}]}},
      // {'input' : ''.toList(), 'expectedOutput' : {'state': 'error', 'output': [{'result': '', 'state': 'error'}]}},
    ...
    _inputsToExpected.forEach((elem) {
      test('formulas: ${elem['formula']}, values: ${elem['values']}', () {
        var _actual = getOutput(elem['formulas'], Solve(elem['formulas']));
