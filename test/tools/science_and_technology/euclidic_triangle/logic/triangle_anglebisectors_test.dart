  ...
  group("triangle.triangleAngleBiSectorsXY:", () {
    List<Map<String, Object?>> _inputsToExpected = [
      ...
      {'inputA': XYPoint(x: 1, y: 1), 'inputB': XYPoint(x: 2, y: 2), 'inputC': XYPoint(x: 3, y: 3),
        'expectedOutput': TriangleSides(a: 1.885618083164127, b: 1.0536712214319115e-8, c: 1.885618083164127)},
      {'inputA': XYPoint(x: 0, y: 0), 'inputB': XYPoint(x: 0, y: 3), 'inputC': XYPoint(x: 4, y: 0),
        'expectedOutput': TriangleSides(a: 2.424366106925306, b: 3.3541019662496843, c: 4.216370213557839)},
    ];
