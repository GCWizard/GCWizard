  ...
  group("triangle.triangleAnglesXY:", () {
    List<Map<String, Object?>> _inputsToExpected = [
      {'inputA': XYPoint(x: 0, y: 0), 'inputB': XYPoint(x: 0, y: 0), 'inputC': XYPoint(x: 0, y: 0),
        'expectedOutput': TriangleInteriorAngles(alpha: double.nan, beta: double.nan, gamma: double.nan)},
      ...
      {'inputA': XYPoint(x: 1, y: 1), 'inputB': XYPoint(x: 2, y: 2), 'inputC': XYPoint(x: 3, y: 3),
        'expectedOutput': TriangleInteriorAngles(alpha: 8.537736462515939e-7, beta: 179.99999914622634, gamma: 8.537736462515939e-7)},
      {'inputA': XYPoint(x: 0, y: 0), 'inputB': XYPoint(x: 0, y: 3), 'inputC': XYPoint(x: 4, y: 0),
        'expectedOutput': TriangleInteriorAngles(alpha: 90.0, beta: 53.13010235415599, gamma: 36.86989764584401)},
    ];
